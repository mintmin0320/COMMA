...
const AskPage = () => {
  ...
  const postPost = async () => {
    const url = `${process.env.REACT_APP_SERVER_DOMAIN}/adminQuestionPost`;
    const params = {
      writerId: userId,
      title: title,
      content: postContent
  ...
  const postComment = async (postId) => {
    const url = `${process.env.REACT_APP_SERVER_DOMAIN}/adminQuestionPost/comment`;
    const params = {
      writerId: userId,
      postId: postId,
  ...
  const getPostsFirst = async () => {
    const url = `${process.env.REACT_APP_SERVER_DOMAIN}/adminQuestionPosts`;
    const res = await axios.get(url + "/" + userId);
    setData(res.data.result);
  }
  const MorePageFirst = async () => {
    const url = `${process.env.REACT_APP_SERVER_DOMAIN}/adminQuestionPosts/` + userId;
    let pageNumbers = [];
    let i, res;
  ...
  const getDataIndex = async (number) => {
    var url = `${process.env.REACT_APP_SERVER_DOMAIN}/adminQuestionPosts/` + userId;
