...
const AskPage = () => {
  ...
  const postPost = async () => {
    const url = 'http://210.121.173.182/adminQuestionPost';
    const params = {
      writerId: userId,
      title: title,
      content: postContent
  ...
  const postComment = async (postId) => {
    const url = 'http://210.121.173.182/adminQuestionPost/comment';
    const params = {
        writerId: userId,
        postId: postId,
  ...
  const getPostsFirst =async()=> {
    const url = "http://210.121.173.182/adminQuestionPosts";
    const res = await axios.get(url+"/"+userId);
    setData(res.data.result);
  }
  const MorePageFirst =async()=> {
    const url = "http://210.121.173.182/adminQuestionPosts/"+userId;
    let pageNumbers = [];
    let i, res;
  ...
  const getDataIndex = async(number) => {
    var url = "http://210.121.173.182/adminQuestionPosts/"+userId;
